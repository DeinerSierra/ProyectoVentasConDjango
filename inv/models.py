...
class UnidadMedida(ClaseModelo):
    ...
    descripcion = models.CharField(max_length=100, help_text="Descripción de la medida", unique=True)
    def __str__(self):
        return f'{self.descripcion}'
    def save(self):
        self.descripcion = self.descripcion.upper()
...
class Producto(ClaseModelo):
    ...
    unidad_medidad = models.ForeignKey(UnidadMedida, on_delete=models.CASCADE)
