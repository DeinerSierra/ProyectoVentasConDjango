...
class CategoriaForm(forms.ModelForm):
    class Meta:
        ...
        labels = {'descripcion':'Descripción de las categorias','estado':'Estado'}
...
class SubCategoriaForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {'descripcion':'Subcategoria','estado':'Estado'}
        widget = {'descripcion': forms.TextInput}
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        for field in iter(self.fields):
...
class ProductoForm(forms.ModelForm):
    ...
    class Meta:
        model = Producto
        fields = ['codigo','codigo_barra','descripcion','estado','precio','existencia','ultima_compra','marca','subcategoria','unidad_medidad']
