...
from inv.views import CategoriaView, CategoriaNew, CategoriaEdit, CategoriaDel, ProductoEdit, ProductoNew, ProductoView,SubCategoriaView, SubCategoriaNew,SubCategoriaEdit,SubCategoriaDel,MarcaNew,MarcaView,MarcaEdit, UMEdit, UMNew, UMView,marca_inactivar, producto_inactivar, um_inactivar
...
urlpatterns = [
    ...
    path('unidadmedidad/', UMView.as_view(), name='um_list'),
    path('unidadmedidad/new', UMNew.as_view(), name='um_new'),
    path('unidadmedidad/edit/<int:pk>', UMEdit.as_view(), name='um_edit'),
    path('unidadmedidad/inactivar/<int:id>', um_inactivar, name='um_inactivar'),
